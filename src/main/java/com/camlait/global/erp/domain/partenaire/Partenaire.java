...
public abstract class Partenaire extends Entite {
	...
	public GroupePartenaire getGroupePartenaire() {
		return groupePartenaire;
	}

	public void setGroupePartenaire(GroupePartenaire groupePartenaire) {
	...
	public Collection<ModeleDeReglement> getModeleDeReglements() {
		return modeleDeReglements;
	}

	public void setModeleDeReglements(Collection<ModeleDeReglement> modeleDeReglements) {
