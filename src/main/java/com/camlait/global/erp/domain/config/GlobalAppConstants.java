...
public class GlobalAppConstants {
    ...
    public final static String PRODUCT_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".produit";
    public final static String DOCUMENT_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".document";
    public final static String AUTH_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".auth";
    public final static String STORE_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".entrepot";
    public final static String IMMO_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".immobilisation";
    public final static String INVENTORY_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".inventaire";
    public final static String LOCAL_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".localisation";
    public final static String OPERATION_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".operation";
    public final static String PARTNER_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".partenaire";
    public final static String BMQ_DOMAIN_BASE_PACKAGE = ROOT_PACKAGE + DOMAIN_BASE_PACKAGE + ".bmq";
