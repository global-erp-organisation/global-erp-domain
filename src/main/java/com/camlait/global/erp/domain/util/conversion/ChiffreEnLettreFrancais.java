...
public class ChiffreEnLettreFrancais implements ChiffreEnLettre {

    private static final String[] DIZAINE_NAMES =
            {"", "", "vingt", "trente", "quarante", "cinquante", "soixante", "soixante", "quatre-vingt", "quatre-vingt"};

    private static final String[] uniteNames1 = {"", "un", "deux", "trois", "quatre", "cinq", "six", "sept", "huit", "neuf", "dix", "onze", "douze",
                                                 "treize", "quatorze", "quinze", "seize", "dix-sept", "dix-huit", "dix-neuf"};

    private static final String[] uniteNames2 = {"", "", "deux", "trois", "quatre", "cinq", "six", "sept", "huit", "neuf", "dix"};

    public ChiffreEnLettreFrancais() {
    }
    ...
    private static String convertZeroToHundred(int number) {
        ...
        switch (laDizaine) {
            ...
            case 8:
                if (lUnite == 0) {
                    resultat = DIZAINE_NAMES[laDizaine];
                } else {
                    resultat = DIZAINE_NAMES[laDizaine] + laLiaison + uniteNames1[lUnite];
                }
                break;
            default:
                resultat = DIZAINE_NAMES[laDizaine] + laLiaison + uniteNames1[lUnite];
